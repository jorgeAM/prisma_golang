...
func (client *Client) Post(params PostWhereUniqueInput) *PostExec {
	ret := client.Client.GetOne(
		...
		"post",
		[]string{"id", "title", "published", "createdAt"})
...
type UserUpdateOneWithoutPostInput struct {
	Create     *UserCreateWithoutPostInput     `json:"create,omitempty"`
	Update     *UserUpdateWithoutPostDataInput `json:"update,omitempty"`
	Upsert     *UserUpsertWithoutPostInput     `json:"upsert,omitempty"`
...
type UserCreateInput struct {
	...
	Post  *PostCreateManyWithoutAuthorInput `json:"post,omitempty"`
}

type UserUpdateInput struct {
	Name  *string                           `json:"name,omitempty"`
	Email *string                           `json:"email,omitempty"`
	Post  *PostUpdateManyWithoutAuthorInput `json:"post,omitempty"`
}

type UserUpsertWithoutPostInput struct {
	Update UserUpdateWithoutPostDataInput `json:"update"`
	Create UserCreateWithoutPostInput     `json:"create"`
}
...
type PostCreateInput struct {
	...
	Author    *UserCreateOneWithoutPostInput `json:"author,omitempty"`
}
...
type UserCreateOneWithoutPostInput struct {
	Create  *UserCreateWithoutPostInput `json:"create,omitempty"`
	Connect *UserWhereUniqueInput       `json:"connect,omitempty"`
}
...
type UserCreateWithoutPostInput struct {
	ID    *string `json:"id,omitempty"`
	Name  string  `json:"name"`
	Email *string `json:"email,omitempty"`
}
...
type PostUpdateInput struct {
	Title     *string                        `json:"title,omitempty"`
	Published *bool                          `json:"published,omitempty"`
	Author    *UserUpdateOneWithoutPostInput `json:"author,omitempty"`
}
...
type UserWhereInput struct {
	...
	PostEvery          *PostWhereInput  `json:"post_every,omitempty"`
	PostSome           *PostWhereInput  `json:"post_some,omitempty"`
	PostNone           *PostWhereInput  `json:"post_none,omitempty"`
...
type UserUpdateWithoutPostDataInput struct {
	Name  *string `json:"name,omitempty"`
	Email *string `json:"email,omitempty"`
}
...
func (instance *UserExec) Post(params *PostParamsExec) *PostExecArray {
	var wparams *prisma.WhereParams
	if params != nil {
		wparams = &prisma.WhereParams{
			Where:   params.Where,
